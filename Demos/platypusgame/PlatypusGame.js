...
(lib.PlatypusGame = function() {
	...
	// score
	this.scoreTxt = new createjs.Text("SCORE: 0", "bold 24px Arial", "#ffffff");
...
p.nominalBounds = new createjs.Rectangle(0,0,875.5,400);
...
(lib.Platypus = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(createjs.Tween.get(this).wait(59).call(this.frame_59).wait(1).call(this.frame_60).wait(4).call(this.frame_64).wait(5).call(this.frame_69).wait(1));

	// idle
	this.platypusIdle = new lib.PlatypusIdle();
	this.platypusIdle.setTransform(128.4,9,1,1,-5.6,0,0,128.3,9);

	this.timeline.addTween(createjs.Tween.get(this.platypusIdle).to({rotation:0,regX:128.4,regY:9.1,y:14.1},14,createjs.Ease.get(-0.99)).to({rotation:3.7,regX:128.3,regY:9,y:9.1},16,createjs.Ease.get(1)).to({rotation:0.3,regX:128.8,regY:9.5,x:128.8,y:14},14,createjs.Ease.get(-0.99)).to({rotation:-5.5,regX:128.3,regY:9,x:128.4,y:9},15,createjs.Ease.get(1)).to({_off:true},1).wait(10));
	...
	this.timeline.addTween(createjs.Tween.get(this.instance).wait(60).to({_off:false},0).wait(10));

}).prototype = p = new createjs.MovieClip();
p.nominalBounds = new createjs.Rectangle(-0.2,-9.9,261.6,341.1);
...
(lib.PlatypusIdle = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(createjs.Tween.get(this.instance).to({rotation:-2.8,x:63.7},9,createjs.Ease.get(1)).to({rotation:0,x:63.6},10).wait(1));

	// eye
	this.instance_1 = new lib.Eye("synched",0);
	this.instance_1.setTransform(80.6,253.1,1,1,-10.6,0,0,10.8,13.4);

	this.timeline.addTween(createjs.Tween.get(this.instance_1).wait(4).to({scaleX:1,scaleY:1,rotation:-10.4,regY:13.3,x:80.5,y:253},5,createjs.Ease.get(-0.99)).to({scaleX:1,scaleY:1,rotation:-10.5,regY:13.4,x:80.6,y:253.1},5,createjs.Ease.get(1)).wait(1));

	// balloon
	this.balloon = new lib.Balloon();
	this.balloon.setTransform(129.9,3.9,1,1,0,0,0,56.3,3.9);

	this.timeline.addTween(createjs.Tween.get(this.balloon).wait(1));

	// legback
	this.instance_2 = new lib.LegFront("synched",9);
	this.instance_2.setTransform(182.4,255.1,1,1,0,0,0,13.9,8.8);

	this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_2}]}).wait(20));

	// legfront
	this.instance_3 = new lib.LegFront("synched",0);
	this.instance_3.setTransform(106.4,264.6,1,1,0,0,0,10.5,17.6);

	this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_3}]}).wait(20));

	// body
	this.instance_4 = new lib.Body("synched",0);
	this.instance_4.setTransform(132.1,185.1,1,1,0,0,0,80.1,11.2);

	this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_4}]}).wait(20));

	// tail
	this.instance_5 = new lib.Tail("synched",0);
	this.instance_5.setTransform(214,236.6,1.001,1.004,0,0,5.6,9.8,23.8);

	this.timeline.addTween(createjs.Tween.get(this.instance_5).to({scaleX:1,scaleY:1,skewX:-23.8,skewY:-19.3,regX:9.7,regY:23.5,x:213.9,y:236.5},9,createjs.Ease.get(1)).to({scaleX:1,scaleY:1,skewX:0,skewY:5.6,regX:9.8,regY:23.8,x:214,y:236.6},10).wait(1));

	// legfrontback
	this.instance_6 = new lib.LegFront("synched",0);
	this.instance_6.setTransform(163.7,254.1,0.86,0.86,0,0,0,10.6,17.6);

	this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_6}]}).wait(20));

	// legbackfront
	this.instance_7 = new lib.LegFront("synched",9);
	this.instance_7.setTransform(99.3,263.2,0.884,0.884,0,0,0,13.9,8.8);

	this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_7}]}).wait(20));

}).prototype = p = new createjs.MovieClip();
p.nominalBounds = new createjs.Rectangle(0,0.2,235.4,332);
...
p.nominalBounds = new createjs.Rectangle(0,0.5,72.2,78.5);
...
p.nominalBounds = new createjs.Rectangle(0,0,27.1,23.4);
...
p.nominalBounds = new createjs.Rectangle(0,0.2,111.6,184.9);
...
p.nominalBounds = new createjs.Rectangle(-5.2,-13,67.8,75.7);
...
p.nominalBounds = new createjs.Rectangle(0,0.5,40.1,64.3);
...
(lib.Body = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(createjs.Tween.get(this.instance).to({scaleX:1.03,skewX:23.7,skewY:9},2,createjs.Ease.get(1)).to({scaleX:1,skewX:0,skewY:0},2).wait(1));

	// hair4
	this.instance_1 = new lib.hair4("synched",0);
	this.instance_1.setTransform(80.7,39.1,1,1,0,0,0,2.3,11.7);

	this.timeline.addTween(createjs.Tween.get(this.instance_1).to({scaleY:1.01,skewX:24.2,skewY:15.5},2,createjs.Ease.get(1)).to({scaleY:1,skewX:0,skewY:0},2).wait(1));

	// hair2
	this.instance_2 = new lib.hair2("synched",0);
	this.instance_2.setTransform(35.3,24.4,1,1,0,0,0,2.7,10.8);

	this.timeline.addTween(createjs.Tween.get(this.instance_2).to({scaleX:1.2,skewX:9.7,skewY:43.2,regX:2.8,regY:10.7,x:35.4,y:24.3},2,createjs.Ease.get(1)).to({scaleX:1,skewX:0,skewY:0,regX:2.7,regY:10.8,x:35.3,y:24.4},2).wait(1));

	// hair1
	this.instance_3 = new lib.hair1("synched",0);
	this.instance_3.setTransform(30.4,27.1,1,1,0,0,0,7,9.9);

	this.timeline.addTween(createjs.Tween.get(this.instance_3).to({scaleX:1,scaleY:1.01,skewX:11.1,skewY:1.8,regX:6.9,regY:9.8,x:30.3,y:27},2,createjs.Ease.get(1)).to({scaleX:1,scaleY:1,skewX:0,skewY:0,regX:7,regY:9.9,x:30.4,y:27.1},2).wait(1));
...
p.nominalBounds = new createjs.Rectangle(0,0.5,170.2,111.5);
...
p.nominalBounds = new createjs.Rectangle(0,0.2,6.4,13.5);
...
p.nominalBounds = new createjs.Rectangle(0,0.2,10.6,16.5);
...
p.nominalBounds = new createjs.Rectangle(0,0.2,5.9,13);
...
p.nominalBounds = new createjs.Rectangle(0,0.2,10.1,14.4);
...
p.nominalBounds = new createjs.Rectangle(0,1.4,26.6,77.3);
...
(lib.PlatypusPop = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(createjs.Tween.get(this.instance).to({rotation:-11,regX:63.7,x:79.8,y:271.5},4).wait(6));

	// balloon
	this.instance_1 = new lib.BalloonPop("synched",0);
	this.instance_1.setTransform(129.1,91.1,1,1,0,0,0,55.8,92.7);

	this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_1}]}).wait(10));

	// legback
	this.instance_2 = new lib.LegFront2("synched",0);
	this.instance_2.setTransform(182.4,255.1,1,1,22.3,0,0,13.9,8.7);

	this.timeline.addTween(createjs.Tween.get(this.instance_2).to({rotation:-90.4,regX:13.8,regY:8.8,y:242.9},4).wait(6));

	// legfront
	this.instance_3 = new lib.LegFront2("synched",0);
	this.instance_3.setTransform(106.4,264.7,1,1,46.2,0,0,10.5,17.7);

	this.timeline.addTween(createjs.Tween.get(this.instance_3).wait(1).to({rotation:83,regY:17.6,x:100.7,y:256.7},0).wait(1).to({scaleX:1,scaleY:1,rotation:159,x:103.9,y:248.7},0).wait(1).to({scaleX:1,scaleY:1,rotation:145.3,regX:0,regY:0,x:136.2,y:240.2},0).wait(7));

	// eye
	this.instance_4 = new lib.EyeSurprise("synched",0);
	this.instance_4.setTransform(80.1,248.1,1,1,0,0,0,15,12.5);

	this.timeline.addTween(createjs.Tween.get(this.instance_4).to({rotation:-11,regY:12.6,x:93.4,y:256.3,startPosition:3},4).wait(6));

	// body
	this.instance_5 = new lib.Body("synched",0);
	this.instance_5.setTransform(132.1,185.1,1,1,0,0,0,80.1,11.2);

	this.timeline.addTween(createjs.Tween.get(this.instance_5).to({rotation:-11,x:132.3,y:184.3,startPosition:3},4).wait(6));

	// tail
	this.instance_6 = new lib.Tail("synched",0);
	this.instance_6.setTransform(214,236.6,1.001,1.004,0,0,5.6,9.8,23.8);

	this.timeline.addTween(createjs.Tween.get(this.instance_6).to({scaleX:1.05,skewX:-173.4,skewY:12.1,x:220.2,y:219.7},4).to({skewX:-184,skewY:1.7,regY:23.9,x:220.1},3).to({skewX:-173.4,skewY:12.1,regY:23.8,x:220.2},2).wait(1));

	// legfrontback
	this.instance_7 = new lib.LegFront2("synched",0);
	this.instance_7.setTransform(158.8,246.3,0.86,0.86,51.7,0,0,10.5,17.7);

	this.timeline.addTween(createjs.Tween.get(this.instance_7).to({rotation:-39.3,regY:17.6,y:236.8,startPosition:4},4).to({_off:true},1).wait(5));

	// legbackfront
	this.instance_8 = new lib.LegFront2("synched",0);
	this.instance_8.setTransform(98.6,267.5,0.884,0.884,68.5,0,0,13.9,8.7);

	this.timeline.addTween(createjs.Tween.get(this.instance_8).to({rotation:0,skewX:-125.9,skewY:-127.3,regX:14,regY:8.8,x:98.5,y:262,startPosition:4},4).to({_off:true},1).wait(5));

}).prototype = p = new createjs.MovieClip();
p.nominalBounds = new createjs.Rectangle(0,-59,244.9,392.5);
...
(lib.BalloonPop = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(createjs.Tween.get(this.instance).wait(1).to({rotation:-52.2,regX:8.4,regY:8.5,x:-36.6,y:137.3},0).to({_off:true},1).wait(8));

	// smallChunk2
	this.instance_1 = new lib.balloonChunk4("synched",0);
	this.instance_1.setTransform(19,16.2,1,1,114.5,0,0,8.4,8.4);

	this.timeline.addTween(createjs.Tween.get(this.instance_1).wait(1).to({x:-8.8,y:-29.5},0).to({_off:true},1).wait(8));

	// midChunk1
	this.instance_2 = new lib.balloonChunk2("synched",0);
	this.instance_2.setTransform(15.9,50.7,1,1,0,0,0,14.6,24.9);

	this.timeline.addTween(createjs.Tween.get(this.instance_2).wait(1).to({rotation:8.9,x:-44.4,y:21.3},0).to({_off:true},1).wait(8));

	// midChunk2
	this.instance_3 = new lib.balloonChunk3("synched",0);
	this.instance_3.setTransform(91.7,84,1,1,0,0,0,13.2,26.7);

	this.timeline.addTween(createjs.Tween.get(this.instance_3).wait(1).to({rotation:9,regX:13.4,x:154.3,y:92},0).to({_off:true},1).wait(8));

	// bigChunk
	this.instance_4 = new lib.balloonChunk1("synched",0);
	this.instance_4.setTransform(65,34.3,1,1,0,0,0,33,40.5);

	this.timeline.addTween(createjs.Tween.get(this.instance_4).wait(1).to({x:79.5,y:-17},0).to({_off:true},1).wait(8));

	// flatBalloon
	this.instance_5 = new lib.BurstBalloon("synched",0);
	this.instance_5.setTransform(56.2,143.9,1,0.805,0,0,0,23.5,138.6);

	this.timeline.addTween(createjs.Tween.get(this.instance_5).wait(2).to({scaleY:1,regX:20.5,regY:74.6,x:53.2,y:79.9},0).to({scaleY:1,skewX:-5,x:46.4},2).to({scaleY:1,skewX:4.6,x:59.2},3).wait(1).to({scaleY:1,skewX:2.3,x:56.2,y:79.8},0).wait(1).to({scaleY:1,skewX:0,x:53.2,y:79.9},0).wait(1));
	...
	this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.shape}]}).wait(10));

}).prototype = p = new createjs.MovieClip();
p.nominalBounds = new createjs.Rectangle(1.6,-5.9,103.6,191);
...
p.nominalBounds = new createjs.Rectangle(0,0.3,16.8,16.8);
...
p.nominalBounds = new createjs.Rectangle(0.3,0.3,29.1,49.7);
...
p.nominalBounds = new createjs.Rectangle(0.3,0.3,26.5,53.5);
...
p.nominalBounds = new createjs.Rectangle(0.3,0.3,66,80.9);
...
p.nominalBounds = new createjs.Rectangle(0,0,41,149.2);
...
p.nominalBounds = new createjs.Rectangle(-5.2,-12.9,67.9,75.7);
...
(lib.EyeSurprise = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(createjs.Tween.get(this.instance).to({scaleX:0.63,scaleY:0.63,x:13.6,y:6.1},4).wait(21));

	// Layer 1
	this.instance_1 = new lib.EyeBall("synched",0);
	this.instance_1.setTransform(15,12.5);

	this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_1}]}).wait(25));

}).prototype = p = new createjs.MovieClip();
p.nominalBounds = new createjs.Rectangle(0.2,0.2,30,25);
...
p.nominalBounds = new createjs.Rectangle(0,0,4,4);
...
p.nominalBounds = new createjs.Rectangle(-14.7,-12.2,30,25);
...
p.nominalBounds = new createjs.Rectangle(0,0,139,311);
...
p.nominalBounds = new createjs.Rectangle(-127.2,-41.2,255.5,83.5);
